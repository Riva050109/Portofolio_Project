            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6 z-20">
                        ...
                        <p class="text-white/90">{{ $product->description }}</p>
                        <p class="text-blue-400 font-bold mt-2">Rp{{ number_format($product->price, 0) }}</p>
                    </div>
                </div>
                @endforeach
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div id="notification" x-data="{ show: true }"
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-blue-100">{{ session('success') }}</p>
                        </div>
                        <button
                    ...
                    <form class="bg-white rounded-xl shadow-lg p-6" method="POST" action="{{ route('saran.store') }}">
                        @csrf
                        <div class="mb-4">
                        ...
                        <input type="hidden" name="tanggal_saran" value="{{ now() }}">
                        <button type="submit"
