...
<head>
    ...
    <!-- Styles -->
    <style>
    /* Tailwind CSS v3.2.4 - Only necessary styles kept */
    * {
        ...
        <div class="mt-16">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <a href="https://laravel.com/docs"
                    class="p-6 bg-white dark:bg-gray-800/50 rounded-lg shadow-2xl flex transition-all hover:scale-[1.01]">
                    <div>
                        <div
                ...
                <div class="p-6 bg-white dark:bg-gray-800/50 rounded-lg shadow-2xl">
                    <div>
                        <div
                            class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm">
                            ...
                            <a href="https://forge.laravel.com"
                                class="underline hover:text-gray-700 dark:hover:text-white">Forge</a>,
                            <a href="https://vapor.laravel.com"
                                class="underline hover:text-gray-700 dark:hover:text-white">Vapor</a>,
                            <a href="https://nova.laravel.com"
                                class="underline hover:text-gray-700 dark:hover:text-white">Nova</a>, and
                            <a href="https://envoyer.io"
                                class="underline hover:text-gray-700 dark:hover:text-white">Envoyer</a>
                            ...
                            <a href="https://laravel.com/docs/billing"
                                class="underline hover:text-gray-700 dark:hover:text-white">Cashier</a>,
                            <a href="https://laravel.com/docs/dusk"
                                class="underline hover:text-gray-700 dark:hover:text-white">Dusk</a>,
                            <a href="https://laravel.com/docs/broadcasting"
                                class="underline hover:text-gray-700 dark:hover:text-white">Echo</a>,
                            <a href="https://laravel.com/docs/horizon"
                                class="underline hover:text-gray-700 dark:hover:text-white">Horizon</a>,
                            <a href="https://laravel.com/docs/sanctum"
                                class="underline hover:text-gray-700 dark:hover:text-white">Sanctum</a>,
                            <a href="https://laravel.com/docs/telescope"
                                class="underline hover:text-gray-700 dark:hover:text-white">Telescope</a>, and more.
                        </p>
                    </div>
                </div>
            </div>
