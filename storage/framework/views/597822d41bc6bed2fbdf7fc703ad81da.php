    ...
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="mb-12 px-4 sm:px-8">
            <div class="flex items-center justify-between relative">
                ...
                <!-- Langkah-langkah -->
                <?php $__currentLoopData = []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative z-10 flex flex-col items-center group">
                    <div class="w-14 h-14 rounded-full flex items-center justify-center 
                        <?php if($index < 2): ?> bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-lg transform scale-110 ring-4 ring-blue-200
                        <?php else: ?> bg-white border-2 border-gray-300 text-gray-400 <?php endif; ?>
                        transition-all duration-300 group-hover:scale-105">
                        <?php if($index < 2): ?> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <?php else: ?>
                            <span class="font-bold text-lg"><?php echo e($index + 1); ?></span>
                            <?php endif; ?>
                    </div>
                    <div class="absolute -bottom-7 text-sm font-medium 
                        <?php if($index < 2): ?> text-blue-600 font-semibold <?php else: ?> text-gray-500 <?php endif; ?>">
                        <?php echo e($step); ?>
            ...
            <div class="lg:w-2/3">
                <div
                    ...
                    <div class="p-6 border-b border-gray-100">
                        ...
                        <form id="checkout-form" action="<?php echo e(route('order.place')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <li class="py-4 flex items-start group">
                                <div
                                    ...
                                    <div class="relative">
                                        ...
                                        <?php elseif($imagePath && Storage::disk('public')->exists($imagePath)): ?>
                                ...
                                <div class="ml-4 flex-1 min-w-0">
                                    <h4 class="font-medium text-gray-800 truncate"><?php echo e($item->name); ?></h4>
                                    <p class="text-sm text-gray-500 mt-1">Rp<?php echo e(number_format($item->price, 0)); ?> ×
                    ...
                    <div class="p-6 border-t border-gray-100">
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span class="text-gray-800 font-medium">Rp<?php echo e(number_format($subtotal, 0)); ?></span>
                            </div>
                            <?php if(isset($discount) && $discount > 0): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Diskon</span>
                                <span class="text-blue-600 font-medium">-Rp<?php echo e(number_format($discount, 0)); ?></span>
                            </div>
                            <?php endif; ?>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Ongkos Kirim</span>
                                <span class="text-gray-800 font-medium">Rp<?php echo e(number_format($tax, 0)); ?></span>
                            </div>
                            <div class="flex justify-between pt-3 border-t border-gray-200">
                                <span class="text-gray-800 font-semibold">Total</span>
                                <span class="text-blue-600 text-lg font-bold">Rp<?php echo e(number_format($total, 0)); ?></span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cafe6\resources\views/checkout.blade.php ENDPATH**/ ?>