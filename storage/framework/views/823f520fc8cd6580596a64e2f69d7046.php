...
<head>
    ...
    <title>Kosmeta <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <header class="bg-white/90 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-blue-100">
        ...
        <div id="mobileMenu"
            ...
            <div class="flex flex-col space-y-4">
                ...
                <form action="<?php echo e(route('logout')); ?>" method="POST" class="w-full pt-4 border-t border-gray-200">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
            ...
            <div class="border-t border-gray-200 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <p class="text-gray-500 text-sm mb-4 md:mb-0">
                        &copy; <?php echo e(date('Y')); ?> Kosmeta SMKN 6 Jember. Hak cipta dilindungi.
                    </p>
...
</html><?php /**PATH C:\xampp\htdocs\cafe6\resources\views/layouts/app.blade.php ENDPATH**/ ?>